...
public class DepartmentController {
	...
	public ResponseEntity<String> saveDepartment(@Valid @RequestBody Department department) {
		...
		return new ResponseEntity<>(environment.getProperty("dms.save.success"), HttpStatus.CREATED);
	}

	@PutMapping("/departments/{dno}")
	public ResponseEntity<String> updateDepartment(@PathVariable int dno, @Valid @RequestBody Department department) {

		service.updateDepartment(dno, department);

		return new ResponseEntity<>(environment.getProperty("dms.update.success"), HttpStatus.OK);
	}
	...
	public ResponseEntity<String> deleteByDno(@PathVariable int dno) {
		...
		return new ResponseEntity<>(environment.getProperty("dms.delete.success"), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<Department>> findAllDepartment() {
		...
		return new ResponseEntity<>(service.findAllDepartment(), HttpStatus.OK);
	}

	@GetMapping("/departments/dname/{dname}")
	public ResponseEntity<List<Department>> findByDname(@PathVariable String dname) {

		return new ResponseEntity<>(service.findByDname(dname), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<Integer>> getDnosList() {
		...
		return new ResponseEntity<>(service.getDnosList(), HttpStatus.OK);
	}
}