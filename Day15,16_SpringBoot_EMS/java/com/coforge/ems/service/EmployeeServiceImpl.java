...
public class EmployeeServiceImpl implements EmployeeService {
	...
	@Override
	public List<Employee> findByEname(String ename) throws EmployeeNotFoundException, InvalidEmployeeObjectException {
	...
	@Override
	@Transactional // used if we are committing any changes in the database
