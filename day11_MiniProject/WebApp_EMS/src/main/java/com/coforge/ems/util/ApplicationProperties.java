...
public class ApplicationProperties {
	...
	public static final String password = "Akhila@180305";

	// SQL Queries
	public static final String insertsql = "INSERT INTO tbl_emp VALUES (?,?,?,?)";

	public static final String updatesql = "UPDATE tbl_emp SET ename=?, esal=?, dno=? WHERE eid=?";
	...
	// Failure Messages
	public static final String dbFailed = "FAILED : DB Error Occurred";
